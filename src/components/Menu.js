               ...
               <div className='header'>
                    <div className='container'>
                         ...
                         <ul className='nav-menu active nav-menu'>
                              <li><NavLink exact activeClassName="active_class" to="/"><i class="fas fa-home"></i>Home</NavLink></li>
                              ...
                              <li><NavLink activeClassName="active_class" to='/slots'><i class="fas fa-home"></i>Slots</NavLink></li>
